                ...
                <div class="navbar-nav ms-auto d-flex flex-row">
                    <div class="nav-item dropdown me-3">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            ...
                            <li><a class="dropdown-item" href="#"><i class="fas fa-star text-warning me-2"></i>Review reminder</a></li>
                            <li><a class="dropdown-item" href="#"><i class="fas fa-calendar text-info me-2"></i>Rental completed</a></li>
