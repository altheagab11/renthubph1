                                            ...
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <div class="d-flex flex-wrap gap-1 mt-3">
                                                        <div class="dropdown">
                                                            <button class="btn btn-outline-primary btn-action dropdown-toggle" data-bs-toggle="dropdown">
                                                                <i class="fas fa-cog"></i> Actions
                                                            </button>
                                                            <ul class="dropdown-menu">
                                                                <?php if($product['Prod_Status'] == 'Pending'): ?>
                                                                <li>
                                                                ...
                                                                <?php elseif($product['Prod_Status'] == 'Active'): ?>
                                                                <li>
                                                                    <form method="POST" style="display: inline;">
                                                                        <input type="hidden" name="product_id" value="<?php echo $product['ProductID']; ?>">
        ...
        <script>
            ...
            function bulkApprove() {
                if (confirm('Approve all pending products? This will make them visible to renters.')) {
                    // Implementation for bulk approve would go here
            ...
            function viewProductDetails(productId) {
                ...
                // This could open a modal or redirect to a detailed product page
            }

            // Edit product
            function editProduct(productId) {
                alert('Product editing functionality will be implemented. Product ID: ' + productId);
                // This could open a modal or redirect to an edit form
            }
