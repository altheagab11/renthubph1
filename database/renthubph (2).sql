...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 14, 2025 at 08:03 AM
...
(1, 2, 1, 'Canon EOS 90D DSLR Camera', 'A professional DSLR camera perfect for events, vlogging, and photography. Comes with battery and charger.', 'Canon', 'EOS 90D', 'Like New', 1200.00, 'Per Day', 5000.00, 1, 7, 1, '2025-09-14 05:40:13', '2025-09-14 05:40:13', 'Active', 1, '2025-12-31 23:59:59');
...
(2, 'Sepp Bernard Consulta', 'sepp@gmail.com', '$2y$10$Z5AtEBy/MJWJUkcVvDimZOYTlBvxQf/R5cJcKCncWHH7I7mU1Iume', '+639123456789', 3, '2025-09-14 04:38:43', '2025-09-14 04:38:43', NULL, 0, 'Active', '2005-04-16', 'Male', NULL);
...
--
ALTER TABLE `parent_categories`
  MODIFY `ParentCategoryID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `subscription_payments`
  MODIFY `SubPaymentID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
